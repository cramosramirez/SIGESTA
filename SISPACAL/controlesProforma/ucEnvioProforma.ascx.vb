...
Partial Class controlesProforma_ucEnvioProforma
    ...
    Private Sub SetInfoRoza(ByVal ID_ROZA_SALDO As Int32)
        ...
        If lControlRozaSdo IsNot Nothing Then
            ...
            If Me.cbxID_PROVEEDOR_ROZA.Items.Count > 0 Then
                If lControlRozaSdo.ID_TIPO_ROZA = CAT.TipoRoza.RozaCosechadoraJiboa OrElse _
                    lControlRozaSdo.ID_TIPO_ROZA = CAT.TipoRoza.RozaCosechadoraParticular OrElse _
    ...
    Private Sub HabilitarEdicion(ByVal edicion As Boolean)
        ...
        Me.chkQuerqueo.ClientEnabled = (Me.TIPO_OPERACION = TipoOperacion.Edicion)
    ...
    Public Function Actualizar() As String
        ...
        End If
        mENVIO.ES_QUERQUEO = Me.chkQuerqueo.Checked
    ...
    Private Sub CargarDatosENVIO()
        ...
        Me.chkQuerqueo.Checked = mENVIO.ES_QUERQUEO
    ...
    Public Function EmitirProforma() As String
        ...
        lProforma.USUARIO_ACT = Me.ObtenerUsuario
        lProforma.FECHA_ACT = cFechaHora.ObtenerFechaHora
        lProforma.ES_QUERQUEO = Me.chkQuerqueo.Checked
        ...
        lControlRoza.ES_QUERQUEO = lstControlRozaSaldo(0).ES_QUERQUEO
        If bControlRoza.ActualizarCONTROL_ROZA(lControlRoza) < 1 Then
