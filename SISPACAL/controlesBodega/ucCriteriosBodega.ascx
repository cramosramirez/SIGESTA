...
<table border="0" >
    ...
    <tr id="trTIPO_PLANILLA" runat="server" visible="false">
        ...
        <td>
            <dx:ASPxComboBox ID="cbxTIPO_PLANILLA" AutoPostBack="true" runat="server" ValueType="System.Int32" DataSourceID="odsTipoPlanilla" ValueField="ID_TIPO_PLANILLA" TextField="NOMBRE_TIPO_PLANILLA" Width="300px" >                                                    
