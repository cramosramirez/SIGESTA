                                ...
                                <PanelCollection>
                                    <dx:PanelContent ID="PanelContent1" runat="server">
                                        <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server">
                                            <Items>
                                                <dx:LayoutGroup Caption="Seleccione el Técnico Agrícola para asignarle los lotes" 
                                                    ColCount="2">
                                                    <Items>
                                                        <dx:LayoutItem Caption="Técnico:" ColSpan="2">
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                                                    <dx:ASPxComboBox ID="cbxAGRONOMO" ClientInstanceName="cbxAGRONOMO" Width="300px" DropDownStyle="DropDownList" runat="server" DataSourceID="odsAgronomo" 
                                            ...
                                            <tr>
                                                <td>
                                                    <dx:ASPxButton ID="btnAceptar" AutoPostBack="true" Text="Aceptar" runat="server" >
                                                        <ClientSideEvents Click="AsignarLotes" />    
                                                    </dx:ASPxButton>
                                                </td>
                                                <td>
